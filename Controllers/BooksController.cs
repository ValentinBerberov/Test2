...
namespace Test2.Web.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Title,ReleaseDate,AuthorID,ID")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Title,ReleaseDate,AuthorID,ID")] Book book)
        {
            if (id != book.ID)
            {
                return NotFound();
